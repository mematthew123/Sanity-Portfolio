...
export default function Home() {
  return (
    <main className="container mx-auto bg-black text-white min-h-screen min-w-full pt-12 ">
      <div className=" text-center mx-auto flex flex-col md:flex-row justify-center p-6 ">
    ...
    <div className="flex mx-auto flex-col md:flex-row justify-center p-6 ">
        <div className=" justify-center">
          <Skills />
          <Project/>
          </div>
...
// Compare this snippet from src/components/About.js:
// import React from 'react'
